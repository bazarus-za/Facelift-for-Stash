# Facelift-for-Stash
Implements a completely reimagined landing page in [Stash](https://github.com/stashapp/stash)

Facelift is a premium, feature-rich dashboard and player extension for Stash. It completely revamps the Stash landing page with a modern UI and deep analytics.
---
## 🚀 Key Features
...
* 
### 2. 🌀 Stash Shorts (TikTok/Shorts Feed)
...
### 📊 3. Daily Trends Dashboard
* **Dynamic Calendar Heatmap**: View a calendar interface with activity intensity dots showing your daily usage frequency.
* **Performers & Tags Breakdown**: Click on any date to see which performers and tags you watched the most, along with total plays and watch time.
* **Scene List**: Scroll through a detailed list of every scene played on the selected date.
* 
### 🖼️ 4. Random Image Spotlight & Collage Canvas
